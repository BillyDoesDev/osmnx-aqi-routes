...
\title{
  \textbf{A Pollution-Aware Urban Routing System} \\[-0em]
  \large 8th Semester Final Project \\[-0.7em]
}

\author{
  \begin{tabular}{c}
    \textbf{Dhrubajyoti Mandal} \\
    Computer Science and Engineering \\
    KIIT University \\
    \texttt{22053859@kiit.ac.in}
  \end{tabular}
  \begin{tabular}{c}
    \textbf{Prof. Sujoy Dutta} \\
    Computer Science and Engineering \\
    KIIT University \\
    \texttt{sdattafcs@kiit.ac.in}
  \end{tabular}
}
\date{}
\begin{document}
...
\begin{figure}[htbp]
  ...
  \begin{subfigure}{0.48\textwidth}
    \centering
    \includegraphics[width=\linewidth]{assets/training-vs-validation.png}
    \caption{Training vs Validation Error}
    \label{fig:img1}
  \end{subfigure}
  \hfill
  \begin{subfigure}{0.48\textwidth}
    \centering
    \includegraphics[width=\linewidth]{assets/predicted-vs-actual.png}
    \caption{Prediceted vs Actual PM2.5 Values}
    \label{fig:img2}
  \end{subfigure}
...
The trained model achieved $\text{MAE} = 8.55\;\mu\text{g/m}^3$ and $\text{RMSE} = 14.43\;\mu\text{g/m}^3$ on the test set. Given that observed PM$_{2.5}$ values in Bhubaneswar regularly hit around $800\;\mu\text{g/m}^3$, the relative MAE is approximately 1.027\%, which is sufficient for meaningful route differentiation.

\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\linewidth]{assets/feature-importance.png}
  \caption{Feature Importance}
  \label{fig:feature-importance}
\end{figure}

Further, as seen in figure \ref{fig:feature-importance}, the model relies heavily on \texttt{pm25\_lag1} and the hour of day, as given by \texttt{hour\_cos}.
...
All the code can be found at: \url{https://github.com/BillyDoesDev/osmnx-aqi-routes}.

\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\linewidth]{assets/homepage.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\linewidth]{assets/step-by-step-directions.png}
  \caption{Project Step By Step Directions}
  \label{fig:step-by-step-directions}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\linewidth]{assets/analytics.png}
  \caption{Analytics}
  \label{fig:analytics}
\end{figure}
